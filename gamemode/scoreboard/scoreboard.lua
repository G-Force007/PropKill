...
function PANEL:PerformLayout()
  ...
  self.SuiSc:SetPos( (self:GetWide() - 200), (self:GetTall() - 15) )  
	...
	self.lblSKills:SetPos( self:GetWide() - 45*8.8 - self.lblSKills:GetWide()/2, self.PlayerFrame.y - self.lblPing:GetTall() - 3  )
	self.lblSDeaths:SetPos( self:GetWide() - 45*7 - self.lblSDeaths:GetWide()/2, self.PlayerFrame.y - self.lblPing:GetTall() - 3  )
end
